...
export function reducer(
    ...
    const { maxWinOddsCount, showMobileMenuPanel, counterStartIncreasing, betBoxCount, transitionBalance, previousBalance, betList, storeAmountForAutoplay,
        ...
        featureTriggered, showRealityCheck, storeCurrentTimeForRC, noInternetPopupVisible, storeWinningSymbolData, requestSent, text, closeButton, continueButton } = action;
