...
class MobileViewSettingPanelUI extends Component<IProps, IState> {
    ...
    orientationChange() {
        if (isMobile && window.innerWidth < window.innerHeight) {
            UIManager.getRef("turboSpinRadioButtonMobDisable") && (UIManager.getRef("turboSpinRadioButtonMobDisable").x = 534);
            UIManager.getRef("turboSpinRadioButtonMobDisable") && (UIManager.getRef("turboSpinRadioButtonMobDisable").y = 1060);
            ...
            UIManager.getRef("turboSpinRadioButtonMobDisable") && (UIManager.getRef("turboSpinRadioButtonMobDisable").x = 530);
            UIManager.getRef("turboSpinRadioButtonMobDisable") && (UIManager.getRef("turboSpinRadioButtonMobDisable").y = 758);
