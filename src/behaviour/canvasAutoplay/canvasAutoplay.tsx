...
class CanvasAutoplay extends Component<IProps, IState> {
    ...
    onDragMove(dotName: any, sliderName: any) {
        if (this.dragging) {
            ...
            if (this.sliderDotName == "sliderDot_3") {
                displayValue = (Math.round(this.valueOfSlider / (734/(this.maxValue/((this.props.betList[this.props.currentBetIndex]) / 100)))) * (this.props.betList[this.props.currentBetIndex]) / 100);
                if (this.props.currencyCode) {
                    UIManager.setText(this.selectedInputName, CURRENCY.CurrencyManager.formatCurrencyString(displayValue, true, true, true, true));
                }
                else {
                    UIManager.setText(this.selectedInputName, ((displayValue)).toFixed(2));
                }

                if (displayValue > 0) {
                    this.props.setBalanceDecreasedBy((displayValue).toFixed(2));
                } else {
                    this.props.setBalanceDecreasedBy(Number.POSITIVE_INFINITY);
                    UIManager.setText("sliderDot_3_inputBoxText", '∞');
                }

            } else if (this.sliderDotName == "sliderDot_2") {
                displayValue = this.arbitraryArray[Math.round(this.valueOfSlider / 48)] * (this.props.betList[this.props.currentBetIndex]) / 100;
                if (this.props.currencyCode) {
            ...
            } else if (this.sliderDotName == "sliderDot") {
                displayValue = this.arbitraryArray[Math.round(this.valueOfSlider / 58)] * (this.props.betList[this.props.currentBetIndex]) / 100;
                if (this.props.currencyCode) {
                    UIManager.setText(this.selectedInputName, CURRENCY.CurrencyManager.formatCurrencyString(Math.round(displayValue), true, true, true, true));
                }
                else {
    ...
    onClickValueChange(e: any, sliderDot: any, sliderLine: any, inputBoxValue: any) {
        ...
        if (sliderDot == "sliderDot_3") {
            displayValue = (Math.round(Math.floor(this.x) / (734/(this.maxValue/((this.props.betList[this.props.currentBetIndex]) / 100)))) * (this.props.betList[this.props.currentBetIndex]) / 100);
            if (this.props.currencyCode) {
                UIManager.setText(inputBoxValue, CURRENCY.CurrencyManager.formatCurrencyString(displayValue, true, true, true, true));
            }
            else {
                UIManager.setText(inputBoxValue, (displayValue).toFixed(2));
            }
            if (displayValue > 0) {
                this.props.setBalanceDecreasedBy((displayValue).toFixed(2));
            }
        ...
        } else if (sliderDot == "sliderDot_2") {
            displayValue = this.arbitraryArray[Math.round(Math.floor(this.x) / 48)] * (this.props.betList[this.props.currentBetIndex]) / 100;
            if (this.props.currencyCode) {
        ...
        } else if (sliderDot == "sliderDot") {
            displayValue = this.arbitraryArray[Math.round(Math.floor(this.x) / 58)] * (this.props.betList[this.props.currentBetIndex]) / 100;
            if (this.props.currencyCode) {
                UIManager.setText(inputBoxValue, CURRENCY.CurrencyManager.formatCurrencyString(Math.round(displayValue), true, true, true, true));
            }
            else {
