    ...
    shouldComponentUpdate(nextProps: Readonly<IProps>, nextState: Readonly<IState>, nextContext: any): boolean {
        ...
        if (nextProps.currentBetIndex !== this.props.currentBetIndex ||
            ...
            if (nextProps.increaseBetResult !== this.props.increaseBetResult && !nextProps.showWinCelebration) {
                !nextProps.noInternetPopupVisible && this.enableAllBtn(["btn_autoplay_stop"]);
        ...
        if (this.props.jurisdictionKey !== "social") {
            switch (this.props.languageCode) {
                ...
                case 'hu':
                    ...
                    this.textBetValue && (this.textBetValue.x = 315);
                    break;
                case 'sv':
                case 'de':
                case 'pt':
                case 'da':
                    ...
                    this.textBetColon && (this.textBetColon.x = 338);
                    this.textBetValue && (this.textBetValue.x = 358);

                    this.textCoinValuelabel && (this.textCoinValuelabel.x = 790);
                    this.textCoinColon && (this.textCoinColon.x = 795);
                    this.textCoinValue && (this.textCoinValue.x = 815);
                    break;
                case 'it':
                    this.textBetlabel && (this.textBetlabel.x = 351);
                    this.textBetColon && (this.textBetColon.x = 356);
                    this.textBetValue && (this.textBetValue.x = 376);
                ...
                case 'es':
                    ...
                    this.textBetColon && (this.textBetColon.x = 333);
                    this.textBetValue && (this.textBetValue.x = 353);

                    this.textCoinValuelabel && (this.textCoinValuelabel.x = 765);
                    this.textCoinColon && (this.textCoinColon.x = 770);
                    this.textCoinValue && (this.textCoinValue.x = 790);
                    break;
                case 'gr':
                    this.textBetlabel && (this.textBetlabel.x = 392);
                    this.textBetColon && (this.textBetColon.x = 397);
                    this.textBetValue && (this.textBetValue.x = 417);
                ...
                case 'ro':
                    ...
                    this.textBetValue && (this.textBetValue.x = 320);

                    this.textCoinValuelabel && (this.textCoinValuelabel.x = 778);
                    this.textCoinColon && (this.textCoinColon.x = 783);
                    this.textCoinValue && (this.textCoinValue.x = 803);
                    break;
                default:
                    ...
                    this.textCoinColon && (this.textCoinColon.x = 757) && (this.textCoinColon.y = 30);
                    this.textCoinValue && (this.textCoinValue.x = 777);
            }
        }
    }
    ...
    orientation() {
        ...
        if (window.innerHeight < window.innerWidth) {
            if (this.props.jurisdictionKey == "social") {
                ...
                UIManager.getRef("text_bet_value1_mobile") && (UIManager.getRef("text_bet_value1_mobile").x = 1520) && (UIManager.getRef("text_bet_value1_mobile").y = 938);
            ...
            if (this.props.jurisdictionKey == "social") {
                ...
                UIManager.getRef("text_colonSymbol2") && (UIManager.getRef("text_colonSymbol2").x = 1525) && (UIManager.getRef("text_colonSymbol2").y = 938);
                UIManager.getRef("text_colonSymbol2") && (UIManager.getRef("text_colonSymbol2").visible = true);
