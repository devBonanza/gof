    ...
    shouldComponentUpdate(nextProps: Readonly<IProps>, nextState: Readonly<IState>, nextContext: any): boolean {
        if (nextProps.callFlowManager !== this.props.callFlowManager) {
            if (nextProps.callFlowManager) {
                ...
                let balance = nextProps.balance - nextProps.betList[nextProps.currentBetIndex];
                if (balance == 0 || balance < nextProps.betList[nextProps.currentBetIndex]) {
...
export default withPixiApp(connect(
    (state: Pick<IStore, 'buttonPanelState'|'winShowerState' | 'winCelebrationState' | 'autoplayState' | 'betPanelState' | 'flowManagerState' | 'applicationState' | 'basegameState' | 'behaviourState' | 'freegameState' | 'reelgridState'>): IStateToProps =>
    ({
