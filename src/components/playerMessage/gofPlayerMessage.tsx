...
class GofPlayerMessage extends Component<IProps, IState> {
    ...
    getMobileText(trueString: string, falseString: string) {
        UIManager.getRef(trueString) && (UIManager.getRef(trueString).visible = true);
        UIManager.getRef(falseString) && (UIManager.getRef(falseString).visible = false);
    }
    ...
    desktopSocial1(props: any) {
        ...
        if (props.basegamestate) {
            ...
            if (this.props.jurisdictionKey == "social") {
                ...
                UIManager.getRef("text_Win_value_desktop") && (UIManager.getRef("text_Win_value_desktop").x = 425) && (UIManager.getRef("text_Win_value_desktop").y = 32);
                ...
                UIManager.getRef("text_Balance_value_withSign") && (UIManager.getRef("text_Balance_value_withSign").x = 615) && (UIManager.getRef("text_Balance_value_withSign").y = 32);
                ...
                UIManager.getRef("text_colonSymbol3_desktop") && (UIManager.getRef("text_colonSymbol3_desktop").x = 195) && (UIManager.getRef("text_colonSymbol3_desktop").y = 30);
                UIManager.getRef("text_Win_value_desktop") && (UIManager.getRef("text_Win_value_desktop").x = 215) && (UIManager.getRef("text_Win_value_desktop").y = 32);

                UIManager.getRef("text_bet_label") && (UIManager.getRef("text_bet_label").x = 370) && (UIManager.getRef("text_bet_label").y = 32);
                UIManager.getRef("text_colonSymbol1") && (UIManager.getRef("text_colonSymbol1").x = 375) && (UIManager.getRef("text_colonSymbol1").y = 30);
                UIManager.getRef("text_bet_value") && (UIManager.getRef("text_bet_value").x = 395) && (UIManager.getRef("text_bet_value").y = 32);
            }
        }
        else {
            ...
            if (this.props.jurisdictionKey == "social") {
                ...
                UIManager.getRef("text_colonSymbol1") && (UIManager.getRef("text_colonSymbol1").x = 550) && (UIManager.getRef("text_colonSymbol1").y = 30);
                UIManager.getRef("text_bet_value") && (UIManager.getRef("text_bet_value").x = 570) && (UIManager.getRef("text_bet_value").y = 32);
            }
            else {
                UIManager.getRef("text_Coin_value_label") && (UIManager.getRef("text_Coin_value_label").visible = true);
                UIManager.getRef("text_colonSymbol2") && (UIManager.getRef("text_colonSymbol2").visible = true);
    ...
    orientationChange() {
        ...
        if (this.props.jurisdictionKey == "social") {
            if (window.innerWidth > window.innerHeight) {
                ...
                UIManager.getRef("text_Win_value_mobile") && (UIManager.getRef("text_Win_value_mobile").x = 905) && (UIManager.getRef("text_Win_value_mobile").y = -95);
            } else {
            ...
            if (this.props.inFreeGame) {
                if (window.innerHeight > window.innerWidth) {
                    ...
                    UIManager.getRef("text_Win_value_mobile") && (UIManager.getRef("text_Win_value_mobile").x = 975) && (UIManager.getRef("text_Win_value_mobile").y = 29);
                }
            }
        }
        else {
