  ...
  wintextposition() {
    if (this.props.jurisdictionKey == "social") {
      ...
      if (window.innerHeight > window.innerWidth) {
        ...
        this.textWinvaluemobile && (this.textWinvaluemobile.x = 905) && (this.textWinvaluemobile.y = -95);
      }
    }
    else {
      if (window.innerWidth > window.innerHeight) {
        ...
        this.textWinvaluemobile && (this.textWinvaluemobile.x = 975) && (this.textWinvaluemobile.y = 29);
      } else {
  ...
  landscapeTextAlignment() {
    ...
    if (window.innerWidth > window.innerHeight) {
      if (this.props.jurisdictionKey == "social") {
        ...
        this.mobileTextBetValue && (this.mobileTextBetValue.x = 375) && (this.mobileTextBetValue.y = 1050);
        ...
        this.mobileTextBetValue && (this.mobileTextBetValue.x = 1520) && (this.mobileTextBetValue.y = 1050);

        this.mobileTextWinLabel && (this.mobileTextWinLabel.x = 950) && (this.mobileTextWinLabel.y = 940);
        this.mobileTextMobColonSymbol1 && (this.mobileTextMobColonSymbol1.x = 955) && (this.mobileTextMobColonSymbol1.y = 938);
        this.mobileTextWinValue && (this.mobileTextWinValue.x = 975) && (this.mobileTextWinValue.y = 940);
        ...
        this.Mobiletext_mobColonSymbol4  && (this.Mobiletext_mobColonSymbol4.x = 1500) && (this.Mobiletext_mobColonSymbol4.y = 936);

        this.text_balance_label_mobile  && (this.text_balance_label_mobile.x = 500) && (this.text_balance_label_mobile.y = 936);
        this.Mobiletext_mobColonSymbol5  && (this.Mobiletext_mobColonSymbol5.x = 505) && (this.Mobiletext_mobColonSymbol5.y = 934);
        this.text_balance_value_mobile  && (this.text_balance_value_mobile.x = 525) && (this.text_balance_value_mobile.y = 936);
  ...
  portraitTextAlignment() {
    if (window.innerHeight > window.innerWidth) {
      if (this.props.jurisdictionKey == "social") {
        ...
        this.text_balance_label_mobile  && (this.text_balance_label_mobile.x = 200) && (this.text_balance_label_mobile.y = 1632);
        this.Mobiletext_mobColonSymbol5  && (this.Mobiletext_mobColonSymbol5.x = 205) && (this.Mobiletext_mobColonSymbol5.y = 1630);
        this.text_balance_value_mobile  && (this.text_balance_value_mobile.x = 215) && (this.text_balance_value_mobile.y = 1632);
      ...
      if (window.innerWidth > window.innerHeight) {
        if (this.props.jurisdictionKey == "social") {
          ...
          this.mobileTextBalanceValue && (this.mobileTextBalanceValue.x = 1520) && (this.mobileTextBalanceValue.y = 1050);
          this.Mobiletext_mobColonSymbol5 && (this.Mobiletext_mobColonSymbol5.visible = false);
          this.Mobiletext_mobColonSymbol4  && (this.Mobiletext_mobColonSymbol4.visible = false);
          this.mobileTextWinValue && (this.mobileTextWinValue.visible = false);
          ...
          this.mobileTextBalanceValue && (this.mobileTextBalanceValue.x = 525) && (this.mobileTextBalanceValue.y = 1050);
