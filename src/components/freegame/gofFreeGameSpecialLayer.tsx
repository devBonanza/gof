...
class GofFreeGameSpecialLayer extends Component<IProps, IState> {
    ...
    protected FG_reTrigger_blast: any;
    protected MobileBet_labelFG: any;
    protected MobileBet_ColonFG: any;
    protected MobileBet_valueFG: any;
    protected MobileWin_labelText: any;
    protected MobileWin_ColonText: any;
    protected MobileWin_valueText: any;
    ...
    portraitTextAlignmentFG() {
        if (this.props.jurisdictionKey == "social") {
            if (isMobile && window.innerHeight > window.innerWidth) {
                ...
                this.MobileBalance_valueFG && (this.MobileBalance_valueFG.x = 785) && (this.MobileBalance_valueFG.y = 1900);
                ...
                this.MobileBalance_valueFG && (this.MobileBalance_valueFG.x = 1575) && (this.MobileBalance_valueFG.y = 1050);
            ...
            if (isMobile && window.innerHeight > window.innerWidth) {
                ...
                this.MobileBalance_ColonFG && (this.MobileBalance_ColonFG.x = 205) && (this.MobileBalance_ColonFG.y = 1898);
                this.MobileBalance_valueFG && (this.MobileBalance_valueFG.x = 215) && (this.MobileBalance_valueFG.y = 1900);
                ...
                if (this.props.languageCode === 'pl' ||
                    ...
                    this.props.languageCode === 'sv' ||
                    this.props.languageCode === 'nb') {
                    this.MobileBalance_labelFG && (this.MobileBalance_labelFG.x = 210) && (this.MobileBalance_labelFG.y = 1900);
                    this.MobileBalance_ColonFG && (this.MobileBalance_ColonFG.x = 215) && (this.MobileBalance_ColonFG.y = 1898);
                    this.MobileBalance_valueFG && (this.MobileBalance_valueFG.x = 225) && (this.MobileBalance_valueFG.y = 1900);
                }
            } else {
                this.MobileBalance_labelFG && (this.MobileBalance_labelFG.x = 465) && (this.MobileBalance_labelFG.y = 1050);
                this.MobileBalance_ColonFG && (this.MobileBalance_ColonFG.x = 470) && (this.MobileBalance_ColonFG.y = 1048);
                this.MobileBalance_valueFG && (this.MobileBalance_valueFG.x = 490) && (this.MobileBalance_valueFG.y = 1050);
                ...
                if (this.props.languageCode === 'pl' ||
                    ...
                    this.props.languageCode === 'sv' ||
                    this.props.languageCode === 'nb') {
                    this.MobileBalance_labelFG && (this.MobileBalance_labelFG.x = 420) && (this.MobileBalance_labelFG.y = 1050);
                    this.MobileBalance_ColonFG && (this.MobileBalance_ColonFG.x = 425) && (this.MobileBalance_ColonFG.y = 1048);
                    this.MobileBalance_valueFG && (this.MobileBalance_valueFG.x = 445) && (this.MobileBalance_valueFG.y = 1050);
                }
            }
        }
    }
    ...
    socialPosition() {
        if (this.props.jurisdictionKey === "social") {
            if (window.innerHeight > window.innerWidth) {
                ...
                this.MobileBet_labelFG && (this.MobileBet_labelFG.x = 200) && (this.MobileBet_labelFG.y = 1900);
                this.MobileBet_ColonFG && (this.MobileBet_ColonFG.x = 205) && (this.MobileBet_ColonFG.y = 1898);
                this.MobileBet_valueFG && (this.MobileBet_valueFG.x = 215) && (this.MobileBet_valueFG.y = 1900);

                UIManager.getRef("text_FreeGame_value1_mobileFG") && (UIManager.getRef("text_FreeGame_value1_mobileFG").x = 548) && (UIManager.getRef("text_FreeGame_value1_mobileFG").y = 1550);
                UIManager.getRef("text_FreeGame_label_mobileFG") && (UIManager.getRef("text_FreeGame_label_mobileFG").visible = false);

                this.MobileWin_labelText && (this.MobileWin_labelText.x = 800) && (this.MobileWin_labelText.y = 750);
                this.MobileWin_ColonText && (this.MobileWin_ColonText.x = 805) && (this.MobileWin_ColonText.y = 748);
                this.MobileWin_valueText && (this.MobileWin_valueText.x = 815) && (this.MobileWin_valueText.y = 750);

                // freegame multiplier
                UIManager.getRef("FG_reTrigger_blast_Anim_mobile") && (UIManager.getRef("FG_reTrigger_blast_Anim_mobile").y = 1500);
                switch (this.props.languageCode) {
                    ...
                    case 'fr':
                    case 'ro':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 750);
                        break;
                    case 'bg':
                    case 'hu':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 805);
                        break;
                    case 'es':
                    case 'hr':
                    case 'sr':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 800);
                        break;
                    case 'pl':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 760);
                        break;
                    case 'it':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 755);
                        break;
                    case 'ru':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 790);
                        break;
                    case 'nb':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 690);
                        break;
                    case 'nl':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 840);
                        break;
                    case 'gr':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 825);
                        break;
                    default:
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 720);
                ...
                UIManager.getRef("text_TotalWin_label_mobileFG") && (UIManager.getRef("text_TotalWin_label_mobileFG").x = 1400) && (UIManager.getRef("text_TotalWin_label_mobileFG").y = 940);
                UIManager.getRef("text_TotalWin_value_mobileFG") && (UIManager.getRef("text_TotalWin_value_mobileFG").x = 1290) && (UIManager.getRef("text_TotalWin_value_mobileFG").y = 940);

                this.MobileBet_labelFG && (this.MobileBet_labelFG.x = 400) && (this.MobileBet_labelFG.y = 1050);
                this.MobileBet_ColonFG && (this.MobileBet_ColonFG.x = 405) && (this.MobileBet_ColonFG.y = 1048);
                this.MobileBet_valueFG && (this.MobileBet_valueFG.x = 425) && (this.MobileBet_valueFG.y = 1050);
                ...
                this.MobileWin_labelText && (this.MobileWin_labelText.x = 950) && (this.MobileWin_labelText.y = 29);
                this.MobileWin_ColonText && (this.MobileWin_ColonText.x = 955) && (this.MobileWin_ColonText.y = 27);
                this.MobileWin_valueText && (this.MobileWin_valueText.x = 975) && (this.MobileWin_valueText.y = 29);
                ...
                switch (this.props.languageCode) {
                    case 'bg':
                    case 'hr':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 880);
                        break;
                    case 'cs':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 785);
                        break;
                    case 'da':
                    case 'tr':
                    case 'it':
                    case 'pl':
                    case 'pt':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 830);
                        break;
                    case 'de':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 800);
                        break;
                    case 'ru':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 855);
                        break;
                    case 'sv':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 820);
                        break;
                    case 'es':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 810);
                        UIManager.getRef("text_FreeGame_value1_mobileFG") && (UIManager.getRef("text_FreeGame_value1_mobileFG").x = 580);
                        break;
                    case 'fi':
                    case 'fr':
                    case 'ro':
                        ...
                        break;
                    case 'gr':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 893);
                        break;
                    case 'hu':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 830);
                        UIManager.getRef("text_FreeGame_value1_mobileFG") && (UIManager.getRef("text_FreeGame_value1_mobileFG").x = 580);
                        break;
                    case 'sr':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 870);
                        break;
                    case 'nl':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 925);
                        break;
                    case 'nb':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 760);
                        break;
                ...
                UIManager.getRef("FG_reTrigger_blast_Anim_mobile") && (UIManager.getRef("FG_reTrigger_blast_Anim_mobile").y = 893);
            ...
            if (window.innerHeight > window.innerWidth) {
                ...
                this.MobileBet_labelFG && (this.MobileBet_labelFG.x = 970) && (this.MobileBet_labelFG.y = 1900);
                this.MobileBet_ColonFG && (this.MobileBet_ColonFG.x = 975) && (this.MobileBet_ColonFG.y = 1898);
                this.MobileBet_valueFG && (this.MobileBet_valueFG.x = 985) && (this.MobileBet_valueFG.y = 1900);
                ...
                this.MobileWin_labelText && (this.MobileWin_labelText.x = 818) && (this.MobileWin_labelText.y = 850);
                this.MobileWin_ColonText && (this.MobileWin_ColonText.x = 823) && (this.MobileWin_ColonText.y = 848);
                this.MobileWin_valueText && (this.MobileWin_valueText.x = 833) && (this.MobileWin_valueText.y = 850);
                ...
                switch (this.props.languageCode) {
                    ...
                    case 'pl':
                    case 'tr':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 535);
                        break;
                    case 'da':
                    case 'de':
                    case 'gr':
                    case 'nl':
                    case 'ro':
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 585);
                        break;
                    default:
                        this.FG_reTrigger_blast && (this.FG_reTrigger_blast.x = 565);
                }
                UIManager.getRef("FG_reTrigger_blast_Anim_mobile") && (UIManager.getRef("FG_reTrigger_blast_Anim_mobile").y = 1757);
                ...
                this.MobileBet_labelFG && (this.MobileBet_labelFG.x = 1450) && (this.MobileBet_labelFG.y = 1050);
                this.MobileBet_ColonFG && (this.MobileBet_ColonFG.x = 1455) && (this.MobileBet_ColonFG.y = 1048);
                this.MobileBet_valueFG && (this.MobileBet_valueFG.x = 1475) && (this.MobileBet_valueFG.y = 1050);
    ...
    funCounterTextPortrait(freegameSpinCount: any) {
        ...
        if (this.props.jurisdictionKey === "social") {
            ...
            UIManager.getRef("text_FreeGame_value1_mobileFG") && (UIManager.setText("text_FreeGame_value1_mobileFG", textFreeGamelabelmobileFG + " " + freegameSpinCount + " " + textFreeGameOFlabelmobileFG + " " + textFreeGamevalue2mobileFG));
        }
        else {
    ...
    initializeObjectToVariable() {
        ...
        this.MobileBet_labelFG = UIManager.getRef("Mobiletext_bet_labelFG");
        this.MobileBet_ColonFG = UIManager.getRef("Mobiletext_mobColonSymbol3FG");
        this.MobileBet_valueFG = UIManager.getRef("Mobiletext_bet_valueFG");

        this.MobileWin_labelText = UIManager.getRef("text_Win_label_mobile");
        this.MobileWin_ColonText = UIManager.getRef("text_colonSymbol3_mobile");
        this.MobileWin_valueText = UIManager.getRef("text_Win_value_mobile");
        this.FG_reTrigger_blast = UIManager.getRef("FG_reTrigger_blast_Anim_mobile");
    }
